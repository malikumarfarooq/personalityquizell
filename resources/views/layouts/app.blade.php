...
<head>
    ...
    <title>NeuroProfile - Discover Your Neuro-Emotional Profile</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <h4 class="text-white mb-4"><i class="bi bi-brain me-2"></i>NeuroProfile</h4>
                ...
                <div class="col-lg-2 col-md-4 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="#">Our Science</a></li>
                ...
                <div class="col-lg-2 col-md-4 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="#">Technical Support</a></li>
                    </ul>
                </div>
                <div class="col-lg-2 col-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="#">Data Protection</a></li>
                    </ul>
                </div>
                <div class="col-lg-2 col-md-4">
                    <h5>Connect</h5>
            ...
            <div class="footer-bottom text-center">
                <p class="mb-0">© 2025 NeuroProfile. All rights reserved.</p>
            </div>
        </div>
    </footer>
</div>
